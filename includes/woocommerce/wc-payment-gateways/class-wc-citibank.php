...
/**
 * WC Citibank Gateway Class.
 * Built the citibank method.
 */
class WC_Citibank extends WC_Payment_Gateway {
    ...
    public function init_form_fields() {
        ...
        $this->form_fields = array(
            ...
            'enable_for_methods' => array(
                ...
                'css'           => 'width: 450px;',
                'default'       => '',
                'description'   => __( 'If Citibank is only available for certain methods, set it up here. Leave blank to enable for all methods.' ),
